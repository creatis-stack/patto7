...
import { Upload, Download, ZoomIn, Eye, Ruler, Scissors, Info } from 'lucide-react';

const EmbroideryMotifResizer = () => {
    ...
    <div className="min-h-screen bg-slate-50 p-4 lg:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl lg:text-4xl font-light text-slate-800 mb-2">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
              ...
              <div className="p-4">
                {!imagePreview ? (
                  <div className="border-2 border-dashed border-slate-300 rounded-lg p-8 text-center bg-slate-50">
                    ...
                    <p className="text-slate-600 mb-4 text-sm">Select your prepared motif image</p>
                    <input
                      ref={fileInputRef}
                      type="file"
                      accept="image/*"
            ...
            {imagePreview && (
              <div className="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  {targetMotifWidth && currentMotifWidth && (
                    <div className="text-xs text-slate-600 bg-blue-50 border border-blue-200 rounded px-3 py-2 text-center">
            ...
            {/* Generate Controls */}
            {imagePreview && targetMotifWidth && targetMotifHeight && (
              <div className="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-4">
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      <label className="flex items-center space-x-2 cursor-pointer bg-slate-50 p-3 rounded border hover:bg-slate-100 transition-colors">
                        <input
                          type="radio"
                          name="outputFormat"
                          value="motif-only"
                        ...
                        />
                        <span className="text-sm">Motif Only</span>
                      </label>
                      <label className="flex items-center space-x-2 cursor-pointer bg-slate-50 p-3 rounded border hover:bg-slate-100 transition-colors">
                        <input
                          type="radio"
                          ...
                          className="text-slate-600"
                        />
                        <span className="text-sm">A4 Page</span>
                      </label>
                    </div>
                  </div>
            ...
            {previewImage ? (
                    ...
                    {outputFormat === 'a4-page' ? (
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
                        <p className="text-blue-800 text-xs">
                          <span className="font-medium">Resolution:</span> {Math.round(parseFloat(targetMotifWidth) * 300)} × {Math.round(parseFloat(targetMotifHeight) * 300)} pixels
                        </p>
                      </div>
                    )}
                  </div>
              ...
              <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-12 text-center">
                <div className="text-slate-400">
                  ...
                  <p className="text-sm mb-1">Preview area</p>
...
export default EmbroideryMotifResizer;
